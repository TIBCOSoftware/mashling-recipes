...
sleep 5
if [[ "echo $(cat /tmp/client1.log)" =~ "res : pet:<id:2" ]] && [[ "echo $(cat /tmp/grpc1.log)" =~ "Code identified in response output: 200" ]]
    then
        echo "PASS"
    else
        echo "FAIL"
...
sleep 5
if [[ "echo $(cat /tmp/client2.log)" =~ "res : user:" ]] && [[ "echo $(cat /tmp/grpc2.log)" =~ "Code identified in response output: 200" ]]
    then
        echo "PASS"
    else
        echo "FAIL"
...
sleep 5
if [[ "echo $(cat /tmp/client3.log)" =~ "res : pet:<id:2 name" ]] && [[ "echo $(cat /tmp/grpc3.log)" =~ "Code identified in response output: 200" ]]
    then
        echo "PASS"
    else
        echo "FAIL"
