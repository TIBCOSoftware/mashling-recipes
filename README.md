...
### Creating a recipe
A recipe can be created by customizing an existing recipe in [mashling.io](https://mashling.io) or using [mashling CLI tool](https://github.com/TIBCOSoftware/mashling/tree/master/cli).
